  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        e: common_vendor.n(spinComputed.value ? "spin" : ""),
        f: common_vendor.n(prefx.value),
        g: common_vendor.n(iconComputed.value),
        h: common_vendor.n(customClass.value),
        i: common_vendor.s({
          transform: `rotate(${_rotateDeg.value}deg)`
        }),
        j: common_vendor.s(fontSizeComputed.value),
        k: common_vendor.s({
          color: textColor.value
        }),
        l: common_vendor.s(customCSSStyle.value)
      } : {}, {
        m: isImg.value
      }, isImg.value ? {
        n: common_vendor.o(clickhandle),
        o: common_vendor.o(($event) => emits("longpress", $event)),
        p: iconComputed.value,
        q: common_vendor.n(props.rotate ? "ani" : ""),
        r: common_vendor.n(spinComputed.value ? "spin" : ""),
        s: common_vendor.n(customClass.value),
        t: common_vendor.s({
          transform: `rotate(${_rotateDeg.value}deg)`
        }),
        v: common_vendor.s({
        ...
        w: common_vendor.s(customCSSStyle.value)
      } : {}, {
        x: common_vendor.s({
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-e3e455a0"], ["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-icon/tm-icon.vue"]]);
