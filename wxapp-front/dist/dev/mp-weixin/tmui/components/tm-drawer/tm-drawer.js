  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: !props.hideCancel && !loading.value && !ok_loading.value
      }, !props.hideCancel && !loading.value && !ok_loading.value ? {
        ...
        g: !ok_loading.value && !loading.value
      }, !ok_loading.value && !loading.value ? {
        ...
        j: ok_loading.value || loading.value
      }, ok_loading.value || loading.value ? {
        k: common_vendor.p({
          color: __props.okColor,
          spin: ok_loading.value || loading.value,
          dark: isDark.value,
          _class: isDark.value !== true ? "opacity-4" : "",
          fontSize: 24,
          name: ok_loading.value || loading.value ? "tmicon-shuaxin" : "tmicon-times-circle-fill"
        })
      } : {}) : {}, {
        ...
        o: common_vendor.p({
          dark: props.dark,
          _class: isDark.value !== true ? "opacity-3" : "",
          fontSize: 36,
          name: "tmicon-times-circle-fill"
        })
      } : {}, {
        p: props.disabbleScroll ? "normal" : "auto",
        q: contentHeight.value,
        ...
        v: common_vendor.s(!props.transprent ? tmcomputed.value.borderCss : ""),
        w: common_vendor.s(!props.transprent ? tmcomputed.value.backgroundColorCss : ""),
        x: common_vendor.s(!props.transprent ? tmcomputed.value.shadowColor : ""),
        y: common_vendor.s(customCSSStyle.value),
        z: common_vendor.n(round_rp.value),
        A: common_vendor.n(customClass.value),
        B: common_vendor.sr(drawerANI, "ce9446c4-1,ce9446c4-0", {
          "k": "drawerANI"
        }),
        C: common_vendor.o(playEndEvent),
        D: common_vendor.p({
          reverse: reverse_rp.value,
          width: anwidth.value,
          height: anheight.value,
          ["auto-play"]: false,
          name: aniname.value,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-ce9446c4"], ["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-drawer/tm-drawer.vue"]]);
