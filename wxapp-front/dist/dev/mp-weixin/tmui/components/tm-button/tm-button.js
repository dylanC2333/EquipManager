  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: _icon.value && !_load.value
      }, _icon.value && !_load.value ? {
        b: common_vendor.p({
        ...
        c: common_vendor.t(_label.value),
        ...
        B: props.guildId,
        C: props.publicId,
        D: common_vendor.n(isclickOn.value && !_disabled.value && !_load.value ? props.hoverClass + " bhover" : ""),
        E: common_vendor.n(!_disabled.value && !_load.value ? "webpc" : ""),
        F: common_vendor.n(_load.value || _disabled.value ? "opacity-8" : ""),
        G: common_vendor.n(!_ctx.isDisabledRoundAndriod ? `round-${btnSizeObj.value.round}` : ""),
        ...
        K: common_vendor.s(btnSizeObj.value.w && !props.block ? {
          width: btnSizeObj.value.w + props.unit
        } : ""),
        L: common_vendor.s(tmcomputed.value.borderCss),
        M: common_vendor.s(_bgcolor.value),
        N: common_vendor.s(!_transprent.value && _shadow.value > 0 && !props.text ? tmcomputed.value.shadowColor : ""),
        O: common_vendor.s(customCSSStyle.value)
      });
    };
  }
});
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-f3634985"], ["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-button/tm-button.vue"]]);
