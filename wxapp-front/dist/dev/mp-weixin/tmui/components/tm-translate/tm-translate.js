  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.n(customClass.value)
      } : {}, {
        e: common_vendor.o(hanlder),
        f: common_vendor.n(customClass.value),
        g: common_vendor.s(computedHeight.value ? {
          height: computedHeight.value
        } : ""),
        h: common_vendor.s(computedWidth.value ? {
          width: computedWidth.value
        } : ""),
        i: common_vendor.s(customCSSStyle.value)
      });
    };
  }
});
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-1c8a1639"], ["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-translate/tm-translate.vue"]]);
