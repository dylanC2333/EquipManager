  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        q: common_vendor.s(_height_real.value ? {
          height: _height.value + common_vendor.unref(_props).unit
        } : ""),
        r: common_vendor.s(_width_real.value ? {
          width: _width.value + common_vendor.unref(_props).unit
        } : ""),
        s: common_vendor.s(common_vendor.unref(tmcomputed).borderCss),
        t: common_vendor.s(common_vendor.unref(blur) && common_vendor.unref(store).tmStore.os == "ios" && common_vendor.unref(isNvue) === true ? "" : _bgcolor.value),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c6f3e58c"], ["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-sheet/tm-sheet.vue"]]);
