        ...
        p: common_vendor.f(_data.value, (item, index, i0) => {
          return {
            a: common_vendor.f(item, (item2, index2, i1) => {
              return common_vendor.e({
                a: "96686880-9-" + i0 + "-" + i1 + "," + ("96686880-8-" + i0 + "-" + i1),
                b: common_vendor.p({
                  ["font-size"]: 28,
                  label: item2.date
                }),
                ...
                d: "96686880-10-" + i0 + "-" + i1 + "," + ("96686880-8-" + i0 + "-" + i1),
                e: common_vendor.p({
                  _class: "flex-center",
                  ["font-size"]: 22,
                ...
                g: "96686880-11-" + i0 + "-" + i1 + "," + ("96686880-8-" + i0 + "-" + i1),
                h: common_vendor.p({
                  _class: "flex-center",
                  ["font-size"]: 22,
                  label: "开始"
                ...
                j: "96686880-12-" + i0 + "-" + i1 + "," + ("96686880-8-" + i0 + "-" + i1),
                k: common_vendor.p({
                  _class: "flex-center",
                  ["font-size"]: 22,
                  label: "结束"
                ...
                m: "96686880-13-" + i0 + "-" + i1 + "," + ("96686880-8-" + i0 + "-" + i1),
                n: common_vendor.p({
                  _class: "flex-center",
                  ["font-size"]: 20,
                  label: "始/止"
                ...
                r: common_vendor.p({
                  ...
                  color: item2.extra.color ? item2.extra.color : isSelected(item2.dateStr) ? _color.value : "white",
                  margin: [0, 0],
                  padding: [0, 0]
                }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-calendar-view/range-day.vue"]]);
