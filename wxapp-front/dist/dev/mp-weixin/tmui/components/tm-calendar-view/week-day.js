        ...
        p: common_vendor.f(_dataWeek.value, (item, index, i0) => {
          return {
            ...
            c: common_vendor.f(_data.value[index], (item2, index2, i1) => {
              return {
                a: "45ff2fbf-10-" + i0 + "-" + i1 + "," + ("45ff2fbf-9-" + i0),
                b: common_vendor.p({
                  ["font-size"]: 28,
                  label: item2.date
                }),
            ...
            f: common_vendor.p({
              ...
              color: _weekNum.value == item ? _color.value : "grey-4",
              margin: [0, 4],
              padding: [0, 0]
            }),
            g: index
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-calendar-view/week-day.vue"]]);
