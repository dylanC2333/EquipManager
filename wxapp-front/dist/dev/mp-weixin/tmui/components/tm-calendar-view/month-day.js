        ...
        p: common_vendor.f(_data.value, (item, index, i0) => {
          return {
            a: common_vendor.f(item, (item2, index2, i1) => {
              return common_vendor.e({
                a: "c7087bfa-9-" + i0 + "-" + i1 + "," + ("c7087bfa-8-" + i0 + "-" + i1),
                b: common_vendor.p({
                  ["font-size"]: 28,
                  label: item2.date
                }),
                ...
                d: "c7087bfa-10-" + i0 + "-" + i1 + "," + ("c7087bfa-8-" + i0 + "-" + i1),
                e: common_vendor.p({
                  _class: "flex-center",
                  ["font-size"]: 22,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-calendar-view/month-day.vue"]]);
