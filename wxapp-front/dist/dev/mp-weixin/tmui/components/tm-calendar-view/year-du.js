        ...
        j: common_vendor.f(_data.value, (item2, index2, i0) => {
          return {
            a: common_vendor.f(item2, (item, index, i1) => {
              return {
                a: "262da556-6-" + i0 + "-" + i1 + "," + ("262da556-5-" + i0 + "-" + i1),
                b: common_vendor.p({
                  ["font-size"]: 28,
                ...
                g: common_vendor.p({
                  ...
                  ["paren-class"]: "flex-4",
                  text: _nowDate.value == item.year,
                  color: _nowDate.value == item.year ? _color.value : "grey-4",
                  margin: [4, 4],
                  padding: [0, 0]
                })
              };
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-calendar-view/year-du.vue"]]);
