        ...
        j: common_vendor.f(_data.value, (item2, index2, i0) => {
          return {
            a: common_vendor.f(item2, (item, index, i1) => {
              return {
                a: "67685993-6-" + i0 + "-" + i1 + "," + ("67685993-5-" + i0 + "-" + i1),
                b: common_vendor.p({
                  ["font-size"]: 30,
                  label: item.dateStr
                }),
                c: "67685993-7-" + i0 + "-" + i1 + "," + ("67685993-5-" + i0 + "-" + i1),
                d: common_vendor.p({
                  ["font-size"]: 24,
                  label: item.dateStr2
                }),
                ...
                i: common_vendor.p({
                  ...
                  ["paren-class"]: "flex-3",
                  text: _nowMonth.value == item.month,
                  color: _nowMonth.value == item.month ? _color.value : "grey-4",
                  margin: [4, 4],
                  padding: [0, 0]
                })
              };
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/EquipmentManagerDev/EquipManager/wxapp-front/src/tmui/components/tm-calendar-view/month-quarter.vue"]]);
