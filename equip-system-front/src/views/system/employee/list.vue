<template>
    ...
    <el-table
      ...
      <el-table-column prop="telephone" label="电话号码" sortable="custom"/>
    ...
    <!-- 分页组件 -->
      ...
      <el-form ref="dataForm" :model="employee" label-width="150px" size="small" style="padding-right: 40px;">
        <el-form-item label="员工名称">
          <el-input v-model="employee.employeeName"/>
        </el-form-item>
        <el-form-item label="员工编码">
          <el-input v-model="employee.employeeCode"/>
        </el-form-item>
        <el-form-item label="员工电话">
          <el-input v-model="employee.telephone"/>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="adddialogVisible = false" size="small" icon="el-icon-refresh-right">取 消</el-button>
        <el-button type="primary" icon="el-icon-check" @click="saveEmployee()" size="small">确 定</el-button>
      </span>
    </el-dialog>
    
    <!-- 修改弹框 -->
    <el-dialog title="修改员工" :visible.sync="editdialogVisible" width="40%" >
      <el-form ref="dataForm" :model="employee" label-width="150px" size="small" style="padding-right: 40px;">
        <el-form-item label="员工名称">
          <el-input v-model="employee.employeeName"/>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" icon="el-icon-check" @click="updateEmployee()" size="small">确 定</el-button>
      </span>
    </el-dialog>
...
import api from '@/api/system/employee'
...
export default{
    ...
    methods:{//具体方法列表
      ...
      edit(id){      
          ...
          api.getEmployeeId(id).then(response =>{
      ...
      //添加方法
      saveEmployee(){
        api.saveEmployee(this.employee)
          .then(response =>{
            //提示
            this.$message({
              type: 'success',
